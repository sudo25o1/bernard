...
export function buildAgentSystemPrompt(params: {
  ...
  if (promptMode === "none") {
    return "You are running inside OpenClaw. Your identity is defined in SOUL.md.";
  }

  const lines = [
    "You are running inside OpenClaw. Your identity and how you communicate are defined in SOUL.md - follow it closely.",
    "",
    "## Tooling",
